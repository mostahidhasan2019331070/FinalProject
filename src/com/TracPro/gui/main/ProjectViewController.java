package com.TracPro.gui.main;

import com.TracPro.gui.GUIUtil;
import com.TracPro.gui.calendar.progressController;
import com.jfoenix.controls.JFXButton;
import com.TracPro.gui.calendar.AddTaskViewController;
import com.TracPro.gui.calendar.DayViewController;
import com.TracPro.gui.calendar.KanbanViewController;
import com.TracPro.gui.chat.ChatViewController;
...
public class ProjectViewController implements Initializable {
    ...
    void ProgressButtonAction(ActionEvent event){

        try {
            loadUI(progressController.getRoot());
        }
        catch (IOException e){
            GUIUtil.showError("OOPS can not load progress");
        }
